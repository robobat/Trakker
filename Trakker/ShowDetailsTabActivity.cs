...
namespace Trakker
{
	...
	public class ShowDetailsTabActivity : AppCompatActivity, ViewPager.IOnPageChangeListener, TabLayout.IOnTabSelectedListener
	{
		Toolbar toolbar;
...
//
		...
		void setUpTabLayout ()
		{
			adapter = new ShowDetailsPagerAdapter (this.SupportFragmentManager);

			mAddShows1 = AddShowsFragment.NewInstance (1, "Action");
			mAddShows2 = AddShowsFragment.NewInstance (2, "Drama");
			mAddShows3 = AddShowsFragment.NewInstance (3, "Comedy");


			adapter.addAFragment (mAddShows1);
			adapter.addAFragment (mAddShows2);
			adapter.addAFragment (mAddShows3);
...
//				}
	...
	public class ShowDetailsPagerAdapter : FragmentPagerAdapter
	{
		private readonly string[] Titles = {
			"Popular", "Comedy", "Animation", "Sports"
		};



		public List<Fragment> mFragList = new List<Fragment> ();

		public ShowDetailsPagerAdapter (FragmentManager fm) : base (fm)
		{
			
		}

		public void addAFragment (Fragment m)
		{
			mFragList.Add (m);
		}
